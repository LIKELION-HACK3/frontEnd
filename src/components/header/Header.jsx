    ...
    return (
        <div className={styles.main__wrapper}>
            ...
            <div className={styles.header__buttons}>
                ...
                <div className={styles.header__loginbox} role="button" tabIndex={0} onClick={handleAuthClick} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') handleAuthClick(); }} aria-pressed={authed} title={authed ? '로그아웃' : '로그인'}>
